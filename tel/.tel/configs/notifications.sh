...
export NOTIFICATIONS_ENABLED=false #enable notification daemon (requires api permissions) [true/false]
...
export NOTIFICATIONS_DISPLAY_TYPE=latest # in the status bar module, scroll through each notification or just show latest [scroll/latest]
